...
- Exiba as informações de forma **dinâmica**
- Seja **responsivo**
...
O projeto completo com os arquivos **HTML, CSS e JavaScript** utilizados na aplicação está disponível no arquivo compactado abaixo:
